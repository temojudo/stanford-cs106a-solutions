...
public interface NameSurferConstants {
	...
	public static final int DIAGRAM_FROM_LEFT = 40;

	public static final int DIAGRAM_FROM_BOTTOM = 40;

	public static final int LABELS_FROM_DIAGRAM = 12;

	public static final int NAME_FROM_DIAGRAM = 2;
